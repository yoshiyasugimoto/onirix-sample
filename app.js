...
// ====== Onirix SDK ======
const onirixToken = import.meta.env.VITE_ONIRIX_TOKEN;
console.log(onirixToken);
if (!onirixToken) throw new Error("onirixToken is none.");
const OX = new OnirixSDK(onirixToken);
